<template>
  <div class="parent-home">
    ...
    <div class="parent-top">
      <div class="top-info">
        <div class="img">
          <img :src="userInfo.headimgurl" @error="userInfo.headimgurl = require('../../assets/images/avatar.png')" alt="">
        </div>
        <div class="info">
          <div class="name">
            {{userInfo.sname || '暂无姓名'}}
          ...
          <div class="progressed">
            ...
            <box gap="10px" class="box">
              ...
              <div class="point" :style="'left:' + (percent > 2.5 ? (percent - 2.5) : 0) + '%'" v-if="complete!==0">
              </div>
            </box>
            <div class="total">
              共{{total}}节课
      ...
      <div class="bottom-class">
        ...
        <div class="class-content">
          <div class="class-week">
            <div class="tab-item" v-for="(item, index) in tabArr" :key="index" @click="changeActive(index)"
          ...
          <div class="course-ctn list-wrapper" ref="wrapper">
            <div>
              <div class="courses" v-for="(item,index) in weekClassData[(activeIndex + 1) % 7]" :key="index"
              ...
              <div v-if="!(weekClassData[(activeIndex + 1) % 7] &&weekClassData[(activeIndex + 1) % 7].length )"
                class="noClass">暂无课程安排</div>
            </div>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      initScroll() {
        ...
        const wrapperHeight = winHeight - parseFloat(topHeight) - parseFloat(historyHeight) - parseFloat(titleHeight) -
          parseFloat(week)
