  ...
  <div class="teacher-home">
    ...
    <div class="teacher-top">
      <div class="top-info">
        <div class="flex">
          <div class="img">
            <img :src="infoData.headimgurl" alt v-if="infoData.headimgurl">
    ...
    <div class="teacher-bottom">
      <div class="bottom-history">
        <div class="history history-1" @click="gotoHistory">
          <div>历史上课记录</div>
        </div>
        <div class="history needclick history-2" @click="gotoAttendence">
          <div>考勤记录</div>
        </div>
      </div>
...
<script>
import { Group, Cell, XButton, XHeader, TransferDom, Actionsheet } from "vux";
...
export default {
  ...
  methods: {
    ...
    // 获取学生信息
    getData() {
      API.homeAPI.wxAppGetTeacher({ tid: this.userInfo.tid }).then(data => {
        if (data) {
          this.infoData = data;
        }
      });
    ...
    .bottom-history {
      ...
      .history {
        &.history-1 {
          ...
          font-weight: 500;
          color: #fff;
          background: url(../../assets/images/banner0.png) center center
            no-repeat;
          background-size: contain;
          div {
            background: rgba(75, 185, 194, 0.6);
            ...
            align-items: center;
            justify-content: center;
            outline: 0.02rem solid rgba(75, 185, 194, 0.6);
        ...
        &.history-2 {
          ...
          font-weight: 500;
          color: #fff;
          background: url(../../assets/images/banner1.png) center center
            no-repeat;
          background-size: contain;
          div {
            ...
            align-items: center;
            justify-content: center;
            outline: 0.02rem solid rgba(255, 75, 75, 0.6);
            outline-offset: 0.06rem;
          }
        }
      }
