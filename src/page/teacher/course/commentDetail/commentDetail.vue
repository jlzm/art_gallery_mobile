  ...
  <div class="comment-detail">
    ...
    <div class="course-panel">
      <group v-if="isTeacher">
        <cell :border-intent="false">
          ...
          <div slot="title">{{studentInfo.sname}}</div>
          <div class="time">{{commentDetail.instime && commentDetail.instime.slice(5,16)}}</div>
        </cell>
      </group>
      <!-- <group v-else>
        <cell  :border-intent="false" >
    ...
    <div class="course-panel">
      <editable-input
        ...
        :editable="!hasComment&&isTeacher"
        :val="commentDetail.tev"
      ></editable-input>
    </div>
    <div class="course-panel">
      <group class="needsfocus">
        <cell
          :title="(hasComment || !isTeacher)? '图片预览' : '图片上传'"
          :border-intent="false"
